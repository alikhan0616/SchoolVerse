...
const Navbar = () => {
  return (
    <div className='flex items-center justify-between p-4'>
      ...
      {/* Search Bar */}
      <div className="hidden md:flex items-center gap-2 rounded-full ring-[1.5px] ring-gray-400 px-2">
      ...
      <div className="flex items-center gap-6 w-full justify-end">
        ...
        <div className="flex items-center rounded-full w-7 h-7 justify-center cursor-pointer relative">
          <Image src='/announcement.png' alt="message-icon" height={20} width={20} />
          <div className="absolute -top-3 -right-3 flex items-center justify-center text-white text-sm bg-purple-600 rounded-full w-5 h-5 p-1">1</div>
        </div>
