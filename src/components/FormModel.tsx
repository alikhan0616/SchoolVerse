...
const FormModel = ({table,type,data,id}:{table:
    ...
    id?:number;
        ...
        const Form = () => {
          ...
          <form className="p-4 flex flex-col gap-4">
            ...
            <button className="bg-red-700 w-max self-center text-white py-2 px-4 rounded-md border-none">Delete</button>
  ...
  return (
    ...
    {
    open && <div className="h-screen w-screen absolute left-0 top-0 bg-black/60 z-50 flex items-center justify-center">
